    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <router-link class="nav-link" replace :to="{ path: router('aim-and-scope') }">Aim And Scope</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" replace :to="{ path: router('deliverables') }">Deliverables</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" replace :to="{ path: router('members') }">Members</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" replace :to="{ path: router('forum') }">Forum</router-link>
          </li>
          <li class="nav-item">
